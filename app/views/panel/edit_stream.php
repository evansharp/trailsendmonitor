	...
	<form class="pure-form" method="post" action="<?php echo base_url(); ?>stream/edit/<?php echo $stream['id']; ?>">
		...
		<div class="pure-u-1-3">
			<fieldset class="pure-group">
				...
				<input type="number" length="4" size="4" id="new_stream_resistance" name="new_stream_resistance" step="0.001" placeholder="Shunt Resistence (ohms)" value="<?php echo $stream['shunt_resistance'];?>">
			</fieldset>
			<fieldset class="pure-group">
